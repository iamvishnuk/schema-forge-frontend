  ...
  return (
    <main className='flex h-full min-h-[590px] w-full max-w-full items-center justify-center'>
      <div className='h-full w-full rounded-md p-5'>
        ...
        <h1 className='mt-8 mb-4 text-center text-xl font-bold tracking-[-0.16px] sm:text-left dark:text-[#fcfdffef]'>
        ...
        <p className='mt-6 text-sm font-normal dark:text-[#f1f7feb5]'>
